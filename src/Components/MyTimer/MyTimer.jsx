...
const StyledMyTimer = styled.div`
  ...
  .button {
    color: teal;     //сделать ерроры в формике, авторизацию, таблицу, стилизнуть радио, разные картинки в завис от дейтайма, передачу времени в таймер, что то по завершении медитаци, смену темы
  }
`
